...
<div class="page-container">
    <form action="${pageContext.request.contextPath}/cus/tjcx2" method="post">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="${pageContext.request.contextPath}/Com/hxkh"  class="btn btn-success radius"><i class="Hui-iconfont">&#xe68f;</i> 刷新</a>
            <a href="${pageContext.request.contextPath}/Ex/hxkh"  class="btn btn-warning-outline radius"><i class="Hui-iconfont">&#xe641;</i> 导出数据</a>
        </span>
    </div>
    <table class="table table-border table-bordered table-bg table-sort">
        ...
        <tbody>
        <c:forEach items="${sessionScope.custs3}" var="web">
            <tr class="text-c">

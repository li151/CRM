...
<div class="page-container">
    <form action="${pageContext.request.contextPath}/cus/tjcx4" method="post">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="${pageContext.request.contextPath}/Com/khxx"  class="btn btn-success radius"><i class="Hui-iconfont">&#xe68f;</i> 刷新</a>
            <a href="${pageContext.request.contextPath}/Ex/khxx"  class="btn btn-warning-outline radius"><i class="Hui-iconfont">&#xe641;</i> 导出数据</a>
        </span>
    </div>
    <table class="table table-border table-bordered table-bg table-sort">
        ...
        <tbody>
            <c:forEach items="${sessionScope.custromer}" var="web">
                <tr class="text-c">

...
<article class="page-container">
    <%--这里是添加公告--%>
    <form class="form form-horizontal" id="form-admin-add" action="${pageContext.request.contextPath}/qzkhxx/insertqzkh" method="post">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="khlx" name="khlx">
            </div>
        </div>
...
<script type="text/javascript">
    // khmc,khlx,dh,cz,fzr,dq,hy,jyxm,lxr,qydz,yx,qyxz
    function adduser(){
        if($("#khmc").val()=='' || $("#khmc").val()==null){
            $("#msg1").text("客户名称不能为空!")
            $("#modal-demo").modal("show");
            return false;
        }else if($("#khlx").val()=='' || $("#khlx").val()==null){
            $("#msg1").text("客户类型不能为空!")
            $("#modal-demo").modal("show");
            return false;

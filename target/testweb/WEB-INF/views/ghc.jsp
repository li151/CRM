...
<div class="page-container">
    ...
    <form action="${pageContext.request.contextPath}/cus/tjcx" method="post">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="admin_add('添加客户','${pageContext.request.contextPath}/Com/tjkh','1000','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加客户</a>
            ...
            <a href="${pageContext.request.contextPath}/Com/ghc"  class="btn btn-success radius"><i class="Hui-iconfont">&#xe68f;</i> 刷新</a>
            <a href="${pageContext.request.contextPath}/Ex/excle"  class="btn btn-warning-outline radius"><i class="Hui-iconfont">&#xe641;</i> 导出数据</a>
        </span>
        </div>
        ...
        <tbody>
        <c:forEach items="${sessionScope.custs1}" var="web">
            <tr class="text-c">
                <td><input type="checkbox" value=${web.customername} name="checkbox" id="ss"></td>
